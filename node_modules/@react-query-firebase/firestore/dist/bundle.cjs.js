...
function useFirestoreDocument(queryKey, ref, options, useQueryOptions) {
    ...
    var subscribeFn = react.useCallback(function (callback) {
        ...
        if (ref) {
            unsubscribe = firestore.onSnapshot(ref, {
    ...
    var subscribeFn = react.useCallback(function (callback) {
        ...
        if (query) {
            resolveQuery(query).then(function (res) {
                unsubscribe = firestore.onSnapshot(res, {
                    includeMetadataChanges: includeMetadataChanges,
                }, function (snapshot) {
                    return callback(snapshot);
                });
...
function useFirestoreCollectionMutation(ref, useMutationOptions) {
    return reactQuery.useMutation(function (data) {
        return firestore.addDoc(ref, data);
    }, useMutationOptions);
}
function useFirestoreDocumentMutation(ref, options, useMutationOptions) {
    return reactQuery.useMutation(function (data) {
        if (options) {
            return firestore.setDoc(ref, data, options);
        }
        return firestore.setDoc(ref, data);
    }, useMutationOptions);
}
function useFirestoreDocumentDeletion(ref, useMutationOptions) {
    return reactQuery.useMutation(function () { return firestore.deleteDoc(ref); }, useMutationOptions);
}
function useFirestoreTransaction(firestore$1, updateFunction, useMutationOptions) {
    return reactQuery.useMutation(function () {
        return firestore.runTransaction(firestore$1, updateFunction);
    }, useMutationOptions);
}
 ...
 */
var namedQueryCache = {};
function namedQuery(firestore$1, name) {
    var key = firestore$1.app.name + ":" + name;
    if (namedQueryCache[key]) {
        return namedQueryCache[key];
    }
    return function () {
        return firestore.namedQuery(firestore$1, name).then(function (query) {
            if (query) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, firestore.getDocFromCache(ref)];
                case 1:
                    snapshot = _a.sent();
                    return [3 /*break*/, 6];
                case 2:
                    if (!(source === "server")) return [3 /*break*/, 4];
                    return [4 /*yield*/, firestore.getDocFromServer(ref)];
                case 3:
                    snapshot = _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, firestore.getDoc(ref)];
                case 5:
                    snapshot = _a.sent();
                    _a.label = 6;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(source === "cache")) return [3 /*break*/, 2];
                    return [4 /*yield*/, firestore.getDocsFromCache(query)];
                case 1:
                    snapshot = _a.sent();
                    return [3 /*break*/, 6];
                case 2:
                    if (!(source === "server")) return [3 /*break*/, 4];
                    return [4 /*yield*/, firestore.getDocsFromServer(query)];
                case 3:
                    snapshot = _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, firestore.getDocs(query)];
                case 5:
                    snapshot = _a.sent();
                    _a.label = 6;
                case 6: return [2 /*return*/, snapshot];
...
exports.useFirestoreCollectionMutation = useFirestoreCollectionMutation;
exports.useFirestoreDocument = useFirestoreDocument;
exports.useFirestoreDocumentData = useFirestoreDocumentData;
exports.useFirestoreDocumentDeletion = useFirestoreDocumentDeletion;
exports.useFirestoreDocumentMutation = useFirestoreDocumentMutation;
exports.useFirestoreInfiniteQuery = useFirestoreInfiniteQuery;
exports.useFirestoreInfiniteQueryData = useFirestoreInfiniteQueryData;
exports.useFirestoreQuery = useFirestoreQuery;
exports.useFirestoreQueryData = useFirestoreQueryData;
exports.useFirestoreTransaction = useFirestoreTransaction;
exports.useFirestoreWriteBatch = useFirestoreWriteBatch;
