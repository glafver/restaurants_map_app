			...
			restaurants.forEach((restaurant) => {
				const distance = getDistance(
					{ latitude: crd.latitude, longitude: crd.longitude },
					{
						...
						longitude: restaurant.geolocation.lng,
					}
				);
				...
				>
					{activeMarker === index ? (
						<InfoWindowF
							...
							className="info-windows-container"
						>
							<div className="restaurant-info-window">
								...
								<p className="restaurant-info">
									<FontAwesomeIcon
										...
										icon={faLocationDot}
									/>
									{restaurant.adress ? restaurant.adress : ""}
								</p>
								<p className="restaurant-info">
								...
								<p className="restaurant-info">
									<FontAwesomeIcon className="card-icons" icon={faBook} />
