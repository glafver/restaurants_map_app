		...
		<>
			<div className="filters-container">
				<Form
					...
					className="d-flex flex-column flex-md-row justify-content-around col-lg-9 mx-lg-auto"
				>
					<Form.Group className="m-2">
						<Form.Select className="filter-form-group" {...register("cuisine")}>
							<option value="">
								{searchParams.get("cuisine") || "Filter by cuisine"}
							</option>
					...
					<Form.Group className="m-2">
						<Form.Select className="filter-form-group" {...register("type")}>
							<option value="">
								{searchParams.get("type") || "Filter by type"}
							</option>
					...
					<Button
						className="col-6 col-md-2 m-2 align-self-center filter-button"
						type="submit"
					>
						Apply filters
					</Button>
